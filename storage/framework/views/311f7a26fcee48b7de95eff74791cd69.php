...
<?php $component->withAttributes([]); ?>
    <form method="POST" action="<?php echo e(route('register')); ?>">
        ...
        <!-- Registration Header -->
        <h2 class="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Student Registration</h2>
...
<?php endif; ?>
        ...
        <!-- Note: All registered users are students -->
        <div class="mt-4 text-sm text-gray-600 dark:text-gray-400 italic">
            You are registering as a <strong>Student</strong>. Only teachers are predefined in the system.
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\DELL\Desktop\lms-app\resources\views/auth/register.blade.php ENDPATH**/ ?>